...
export const CANONICAL_WORK_ITEMS_GENERATOR_CONFIG = { output: 'workItems', items: 'state.workItems', listType: 'array', itemType: 'workItem', as: 'workItem', cursor: 'workItemIndex', done: 'end' };
...
function validateMateriaGeneratorConfig(value) {
    ...
    if (value.listType !== canonical.listType)
...
export async function handleRoleGenerationRoute(req, res, deps) {
    if (req.method !== 'POST') {
