...
- [Parallel generation and scoped execution](docs/parallel-loop-orchestration.md) — intrinsic generator-adjacent streams, universal execution scopes, ordered fan-in, utility composition, and revival
- [Parallel workflow operation](docs/parallel-workflow-operation.md) — authoring, same-cwd safety, concurrency, workspace examples, monitoring, recovery, integration, and cleanup
