...
- [Parallel workflow operation](docs/parallel-workflow-operation.md) — authoring, visual interpretation, monitoring, cancellation, recovery, troubleshooting, and cleanup
